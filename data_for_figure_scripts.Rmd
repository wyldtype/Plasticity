...
rm(supp_tab1)
supp_tab2 <- finaldf |> select(gene_name, experiment, effect_size_species, padj_species, effect_size_allele, padj_allele, cor_hybrid, cor_parents, cer, par, level, plasticity) |>
