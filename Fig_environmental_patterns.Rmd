...
# TODO for re-submission: giant-plasticity-heatmap is likely the version of figure 7 we will take forward. We just need to turn each environment's correlations into some kind of z-score so they are more comparable between experiments. And do a permutation test to see if plasticity-diverging genes really do have the same likelihood of diverging in other environments as the rest of the genes 
