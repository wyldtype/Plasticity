...
### SNR cutoff os percentile instead of solid threshold
# clustering with nClust = 2
...
# 1% lowest SNR per species
clusterdf_list_snr1pct <- vector(mode = "list", length = 0)
for (e in c("CC", "HAP4", "LowN", "LowPi", "Heat", "Cold")) {
  cat("*********** working on 2 clusters, SNR @ 1%", "in", e, "*********** \n")
  output <- clusterCountsList(counts_list[grepl(e, names(counts_list))], 
                          .nClust = 2, 
                          ...
                          .is_low_var_df = snrdf,
                          .tree_too = TRUE)
  clusterdf_list_snr1pct[[paste(e, 2, sep = "_")]] <- output
}
clusterdf_snr1pct <- getClusterCombination(clusterdf_list_snr1pct)
...
save(clusterdf, clusterdf_list,
     ...
     clusterdf_snr1pct, clusterdf_list_snr1pct,
