...
Conclusion: 10% of reads mapping to wrong species is a good cutoff. These do tend to be genes that are on the lower end of expression level.
...
par_genedf |> filter(gene %in% cer_biased_genes) |> 
  left_join(y = sgd_lookup, by = c("gene_name"="systematic")) |> 
